...
<body>
    ...
    $(function(){
    	$.ajax({
    		url: "cupon.jqAjax",
    		type: 'get',
    		data:{memberNo: ${ sessionScope.loginUser.memNo }},
	...
	function getPercent(e){
		...
		console.log(roomPrice - (coupon.percent* 0.01)*roomPrice);
		const result3 = roomPrice - (coupon.percent* 0.01)*roomPrice
		
		$('#payPrice').append('<span>' + result3 + '</span>');
		$('#lastPay').append('<span>' + result3 + '</span>');
	}	
    </script>
